...
public class AudioObject : ScriptableObject {
	...
	public AudioClip RandomClip
	{
		...
		{
			//Some other code
			return clips.Length>0?clips[UnityEngine.Random.Range(0,clips.Length)]:null;
		}
	}

        public AudioClip RandomClipWithIndex(out int _index)
        {

            int _tempIndex = UnityEngine.Random.Range(0, clips.Length);

            _index = _tempIndex;

            return clips.Length > 0 ? clips[_index] : null;
           
        }

        public bool avoidPlayingSameClipTwice = false;
	...
	public bool isBGM = false;
        ...
        public class AudioObjectEditor : UnityEditor.Editor
        {
            ...
            SerializedProperty avoidPlayingSameClipTwice;
            ...
            private static readonly string[] _dontIncludeMe_0 = new string[] { "m_Script", "avoidPlayingSameClipTwice", "playClipsSequentially", "clips", "identifier", "maxDistance", "minDistance", "playClipsSequentially", "priority", "maxSources", "minDistance", "maxDistance", "minVolumeMultiplier", "maxVolumeMultiplier", "minPitchMultiplier", "maxPitchMultiplier", "reverbZoneMix", "dopplerLevel", "volumeRolloff", "volumeRolloffCurve", "mixerGroup", "spatialize", "isBGM" };
            private static readonly string[] _dontIncludeMe_1 = new string[] { "m_Script", "avoidPlayingSameClipTwice", "playClipsSequentially", "clips", "identifier", "maxDistance", "minDistance", "volume", "spread", "pitch", "spatialMode2D", "stereoPan", "loop", "minVolumeMultiplier", "maxVolumeMultiplier", "minPitchMultiplier", "maxPitchMultiplier", "reverbZoneMix", "dopplerLevel", "volumeRolloff", "volumeRolloffCurve", "mixerGroup", "spatialize", "isBGM" };
            private static readonly string[] _dontIncludeMe_2 = new string[] { "m_Script", "avoidPlayingSameClipTwice", "playClipsSequentially", "clips", "identifier", "maxDistance", "minDistance", "volume", "spread", "pitch", "spatialMode2D", "stereoPan", "loop", "playClipsSequentially", "priority", "maxSources", "minDistance", "maxDistance", "minVolumeMultiplier", "maxVolumeMultiplier", "minPitchMultiplier", "maxPitchMultiplier", "reverbZoneMix", "dopplerLevel", "volumeRolloff", "volumeRolloffCurve", "mixerGroup", "spatialize", "isBGM" };
            private static readonly string[] _dontIncludeMe_3 = new string[] { "m_Script", "avoidPlayingSameClipTwice", "playClipsSequentially", "clips", "identifier", "maxDistance", "minDistance", "volume", "spread", "pitch", "spatialMode2D", "stereoPan", "loop", "playClipsSequentially", "priority", "maxSources", "minDistance", "maxDistance", "minPitchMultiplier", "maxPitchMultiplier", "minVolumeMultiplier", "maxVolumeMultiplier", "mixerGroup", "spatialize", "isBGM" };
            private static readonly string[] _dontIncludeMe_4 = new string[] { "m_Script", "avoidPlayingSameClipTwice", "playClipsSequentially", "clips", "identifier", "maxDistance", "minDistance", "volume", "spread", "pitch", "spatialMode2D", "stereoPan", "loop", "playClipsSequentially", "priority", "maxSources", "minDistance", "maxDistance", "minPitchMultiplier", "maxPitchMultiplier", "minVolumeMultiplier", "maxVolumeMultiplier", "reverbZoneMix", "dopplerLevel", "volumeRolloff", "volumeRolloffCurve" };
            ...
            void OnEnable()
            {
                ...
                avoidPlayingSameClipTwice = audioObj.FindProperty("avoidPlayingSameClipTwice");
            ...
            private static UnityEngine.Object prevSelection;
            ...
            public override void OnInspectorGUI()
            {
                ...
                if (!GetSingleBoolValue(avoidPlayingSameClipTwice) || audioObj.isEditingMultipleObjects || GetSingleBoolValue(loopClipsSequentially))
                {
                ...
                else
                {
                    ...
                    Tools.MLPASExtensionMethods.Toggle(loopClipsSequentially, new GUIContent("Play Clips Sequentially", "Disable \"Avoid Playing Same Clip Twice\" to use this parameter"));
                    EditorGUI.EndDisabledGroup();
                }

                if (!GetSingleBoolValue(loopClipsSequentially) || audioObj.isEditingMultipleObjects || GetSingleBoolValue(avoidPlayingSameClipTwice))
                {
     

                    Tools.MLPASExtensionMethods.Toggle(avoidPlayingSameClipTwice, new GUIContent("Avoid Playing Same Clip Twice", "The source will try to get a different clip every time it plays"));
                }
                else
                {
              
                    EditorGUI.BeginDisabledGroup(true);
                    Tools.MLPASExtensionMethods.Toggle(avoidPlayingSameClipTwice, new GUIContent("Avoid Playing Same Clip Twice", "Disable \"Play Clips Sequentially\" to use this parameter"));
                    EditorGUI.EndDisabledGroup();
                }
