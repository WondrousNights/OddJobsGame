...
namespace AlmenaraGames
{
    ...
    public static class MLPASRunTimeExtensionMethods
    {
        ...
        public static void PlayWithDifferentPitch(this AudioObject ao, int channel, Vector3 position, float pitchMultiplier, float delay)
        {
            MultiAudioManager.PlayDelayedAudioObject(ao, delay, channel, position).PitchOverride = ao.pitch * pitchMultiplier;
        }

        public static void PlayWithDifferentPitch(this AudioObject ao, int channel, Transform targetToFollow, float pitchMultiplier, float delay)
        {
            MultiAudioManager.PlayDelayedAudioObject(ao, delay, channel, targetToFollow).PitchOverride = ao.pitch * pitchMultiplier;
        }
