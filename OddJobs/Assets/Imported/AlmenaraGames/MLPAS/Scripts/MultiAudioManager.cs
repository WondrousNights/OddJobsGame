...
namespace AlmenaraGames{
    ...
    public class MultiAudioManager : MonoBehaviour {
        ...
        public static readonly string Version = "3.5c";
	...
	void Awake () {
		...
		if (!ignore) {
                ...
                sfxMixerGroup = config.sfxAudioMixerGroup;
			bgmMixerGroup= config.bgmAudioMixerGroup;
	...
	public void ReloadConfig()
	{
        ...
        public static AudioObject GetAudioObjectByIdentifier(string identifier, bool showWarning=true)
	    {
            ...
            if (showWarning)
            {
                ...
                {
                    Debug.LogWarning("Can't get an <b>Audio Object</b> with the identifier: " + "<b>" + identifier + "</b>" + "\nRemember that the <b>Audio Object</b> needs to be in the \"Resources\\Global Audio Objects\" folder and the identifier is case sensitive. Also be sure to use the: " + MultiAudioManager.runtimeIdentifierPrefix + " prefix" + " if you are trying to get an <b>Audio Object</b> via a Runtime Identifier.");
                }
            }
            return null;
	...
	public class MultiAudioManagerEditor : UnityEditor.Editor
	{
